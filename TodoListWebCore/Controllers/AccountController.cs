...
namespace TodoListWebCore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var identityInfo = await IdentityInfo.FromIdentity((System.Security.Claims.ClaimsIdentity)this.User.Identity, SiteConfiguration.ApplicationName, relatedApplicationIdentities, graphClient);
